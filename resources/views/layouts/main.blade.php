    ...
    <nav class="bg-white text-slate-800 p-4 shadow-md sticky top-0 z-50">
        <div class="container mx-auto flex items-center justify-between">
            ...
            <div class="flex-1 flex justify-center hidden md:flex space-x-8">
                ...
                <a href="/tentang-kami"
                    class="{{ request()->is('tentang-kami') ? 'text-blue-700 border-b-2 border-blue-700 pb-1 font-bold' : 'text-slate-500 hover:text-blue-600' }} font-medium transition-all duration-300">
                    Tentang Kami
                </a>

                <a href="/tim-kami"
                    class="{{ request()->is('tim-kami') ? 'text-blue-700 border-b-2 border-blue-700 pb-1 font-bold' : 'text-slate-500 hover:text-blue-600' }} font-medium transition-all duration-300">
                    Tim Kami
                </a>
            </div>
